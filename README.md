...
*El backend esta conformado por el c++ y el PHP. El primero, es el que se encarga de recibir los parámetros enviados por el usuario, procesarlo y mandar una respuesta a través de archivos txt en formato csv. El PHP, es el que se encarga de ejecutar el c++ y enviar estos mismos parámetros y recibir una respuesta de que el mismo programa termino, al mismo tiempo, se encarga de manejar los request's de usuarios para poder cambiar de página.*
